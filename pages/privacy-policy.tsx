...
export default function PrivacyPolicy() {
  return (
    <section className="max-w-4xl mx-auto p-8 ows_article">
      <h1 className="text-3xl my-4">Privacy Policy</h1>
      ...
      <h1 className="text-3xl my-4">Interpretation and Definitions</h1>
      <h2 className="text-xl my-2">Interpretation</h2>
      <p>
      ...
      <h2 className="text-xl my-2">Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Kansas, United States
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Outland Web Solutions, accessible
            from <Link href="/">https://outlandwebsolutions.com</Link>
          </p>
        </li>
        <li>
          <p>
      ...
      <h1 className="text-3xl my-4">Collecting and Using Your Personal Data</h1>
      <h2 className="text-xl my-2">Types of Data Collected</h2>
      <h3 className="text-lg my-2">Personal Data</h3>
      <p>
      ...
      <h3 className="text-lg my-2">Tracking Technologies and Cookies</h3>
      <p>
      ...
      <h2 className="text-xl my-2">Use of Your Personal Data</h2>
      ...
      <h2 className="text-xl my-2">Retention of Your Personal Data</h2>
      <p>
      ...
      <h2 className="text-xl my-2">Disclosure of Your Personal Data</h2>
      <h3 className="text-lg my-2">Business Transactions</h3>
      <p>
      ...
      <h3 className="text-lg my-2">Law enforcement</h3>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 className="text-lg my-2">Other legal requirements</h3>
      <p>
      ...
      <h2 className="text-xl my-2">Security of Your Personal Data</h2>
      <p>
      ...
      <h1 className="text-3xl my-4">Changes to this Privacy Policy</h1>
      <p>
      ...
      <ul>
        <li>By email: info@outlandwebsolutions.com</li>
      </ul>
    </section>
  )
}
