  ...
  return (
    <section className="bg-purple-200 p-8 text-stone-900">
      <div className="flex w-full flex-col justify-center py-8 lg:order-last">
        <h2 className="mb-8 w-full text-center text-5xl">
      ...
      <div className="flex flex-col flex-wrap lg:flex-row">
        <article className="flex w-full flex-col justify-between p-8 lg:w-1/3">
          <div className="align-center mx-auto flex h-full w-full lg:w-1/2">
            <Image
              src={developer}
              alt="Graphic of developer working behind a monitor"
            />
          </div>
          <h3 className="p-8 text-center text-3xl">Custom Web Development</h3>
        </article>
        <article className="flex w-full flex-col justify-between p-8 lg:w-1/3">
          <div className="align-center mx-auto flex h-full w-full lg:w-1/2">
            <Image
          ...
          <h3 className="p-8 text-center text-3xl">
